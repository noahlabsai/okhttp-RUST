...
pub const HTTP_SWITCHING_PROTOCOLS: i32 = 101;

// `102 Processing` (WebDAV - RFC 2518)
pub const HTTP_PROCESSING: i32 = 102;

// `103 Early Hints (Early Hints - RFC 8297)`
pub const HTTP_EARLY_HINTS: i32 = 103;

// `307 Temporary Redirect` (HTTP/1.1 - RFC 7231)
pub const HTTP_TEMP_REDIRECT: i32 = 307;

// `308 Permanent Redirect` (HTTP/1.1 - RFC 7538)
pub const HTTP_PERM_REDIRECT: i32 = 308;

// `421 Misdirected Request` (HTTP/2 - RFC 7540)
pub const HTTP_MISDIRECTED_REQUEST: i32 = 421;